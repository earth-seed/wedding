      ...
      >
        <div className="max-w-3xl mx-auto space-y-12 sm:space-y-16">
          <div className="border-l-2 border-primary/30 pl-4 sm:pl-6 md:pl-8 py-4 sm:py-6">
            <h3 className="text-xl sm:text-2xl font-serif mb-3 sm:mb-4">Getting There</h3>
            <div className="space-y-4 sm:space-y-6">
              <div>
                <h4 className="font-serif text-base sm:text-lg mb-2">Flight Information</h4>
              ...
              <div>
                <h4 className="font-serif text-base sm:text-lg mb-2">Airport Transfer</h4>
                <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
          ...
          <div className="border-l-2 border-primary/30 pl-4 sm:pl-6 md:pl-8 py-4 sm:py-6">
            <h3 className="text-xl sm:text-2xl font-serif mb-3 sm:mb-4">Where to Stay</h3>
            <div className="space-y-4 sm:space-y-6">
              <div>
                <h4 className="font-serif text-base sm:text-lg mb-2">Akyaka Valley Hotels</h4>
              ...
              <div>
                <h4 className="font-serif text-base sm:text-lg mb-2">Nuup Hotel - Ceremony Venue</h4>
                <p className="text-sm sm:text-base text-muted-foreground leading-relaxed mb-3 sm:mb-4">
              ...
              <div>
                <h4 className="font-serif text-base sm:text-lg mb-2">House Rentals</h4>
                <p className="text-sm sm:text-base text-muted-foreground leading-relaxed mb-3 sm:mb-4">
          ...
          <div className="border-l-2 border-primary/30 pl-4 sm:pl-6 md:pl-8 py-4 sm:py-6">
            <h3 className="text-xl sm:text-2xl font-serif mb-3 sm:mb-4">About Akyaka</h3>
            <p className="text-sm sm:text-base text-muted-foreground leading-relaxed mb-3 sm:mb-4">
          ...
          <div className="border-l-2 border-primary/30 pl-4 sm:pl-6 md:pl-8 py-4 sm:py-6">
            <h3 className="text-xl sm:text-2xl font-serif mb-3 sm:mb-4">Exploring Turkiye</h3>
            <p className="text-sm sm:text-base text-muted-foreground leading-relaxed mb-3 sm:mb-4">
            ...
            <div className="space-y-3 sm:space-y-4">
              <div>
                <h4 className="font-serif text-base sm:text-lg mb-2">Istanbul</h4>
                <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
              ...
              <div>
                <h4 className="font-serif text-base sm:text-lg mb-2">Cappadocia</h4>
                <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
              ...
              <div>
                <h4 className="font-serif text-base sm:text-lg mb-2">Konya</h4>
                <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
              ...
              <div>
                <h4 className="font-serif text-base sm:text-lg mb-2">Kas, Antalya</h4>
                <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
