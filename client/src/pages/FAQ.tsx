      ...
      >
        <div className="max-w-4xl mx-auto space-y-6 sm:space-y-8">
          ...
          <div className="animate-fade-in">
            <h3 className="text-xl sm:text-2xl font-serif mb-4 sm:mb-6 text-foreground">General Questions</h3>
            <div className="space-y-4 sm:space-y-6">
              <div className="border-l-2 border-primary/30 pl-4 sm:pl-6 py-3 sm:py-4">
                <h4 className="text-base sm:text-lg font-display mb-2 text-foreground">What should I wear?</h4>
              ...
              <div className="border-l-2 border-primary/30 pl-4 sm:pl-6 py-3 sm:py-4">
                <h4 className="text-base sm:text-lg font-display mb-2 text-foreground">Will there be food for dietary restrictions?</h4>
                <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
              ...
              <div className="border-l-2 border-primary/30 pl-4 sm:pl-6 py-3 sm:py-4">
                <h4 className="text-base sm:text-lg font-display mb-2 text-foreground">What happens if it rains?</h4>
                <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
          ...
          {/* Travel & Logistics */}
          <div className="animate-fade-in">
            <h3 className="text-xl sm:text-2xl font-serif mb-4 sm:mb-6 text-foreground">Travel & Logistics</h3>
            <div className="space-y-4 sm:space-y-6">
              <div className="border-l-2 border-primary/30 pl-4 sm:pl-6 py-3 sm:py-4">
                <h4 className="text-base sm:text-lg font-display mb-2 text-foreground">Do I need a visa to visit Turkey?</h4>
                <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
              ...
              <div className="border-l-2 border-primary/30 pl-4 sm:pl-6 py-3 sm:py-4">
                <h4 className="text-base sm:text-lg font-display mb-2 text-foreground">What currency should I bring?</h4>
                <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
              ...
              <div className="border-l-2 border-primary/30 pl-4 sm:pl-6 py-3 sm:py-4">
                <h4 className="text-base sm:text-lg font-display mb-2 text-foreground">Is there a dress code for the rehearsal dinner?</h4>
                <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
          ...
          {/* Ceremony & Reception */}
          <div className="animate-fade-in">
            <h3 className="text-xl sm:text-2xl font-serif mb-4 sm:mb-6 text-foreground">Ceremony & Reception</h3>
            <div className="space-y-4 sm:space-y-6">
              <div className="border-l-2 border-primary/30 pl-4 sm:pl-6 py-3 sm:py-4">
                <h4 className="text-base sm:text-lg font-display mb-2 text-foreground">Will the ceremony be in English or Turkish?</h4>
                <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
              ...
              <div className="border-l-2 border-primary/30 pl-4 sm:pl-6 py-3 sm:py-4">
                <h4 className="text-base sm:text-lg font-display mb-2 text-foreground">Can I take photos during the ceremony?</h4>
                <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
              ...
              <div className="border-l-2 border-primary/30 pl-4 sm:pl-6 py-3 sm:py-4">
                <h4 className="text-base sm:text-lg font-display mb-2 text-foreground">Will there be alcohol served?</h4>
                <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
